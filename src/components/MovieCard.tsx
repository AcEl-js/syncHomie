...
const MovieCard = ({ title, image, rating, genre }: MovieCardProps) => {
  return (
    <div className="min-w-[280px]  bg-[#0D0D1F]  rounded-lg overflow-hidden">
      ...
      <div className=' absolute right-2 top-2'>
        ...
        <div className="inset-0 bg-gradient-to-t from-black/90 via-black/30 to-transparent opacity-0 group-hover:opacity-100 transition-opacity duration-300">
          <div className="absolute top-0 left-0 right-0 p-2 flex justify-center">
            <button className=" bg-[#1A1A2E] text-white p-2 rounded flex items-center justify-center gap-2 hover:bg-[#252538] transition-colors">
