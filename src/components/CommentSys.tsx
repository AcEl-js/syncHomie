...
export default function CommentSys() {
  ...
  if (isLoading) {
    return <div className="min-h-screen bg-gray-900 text-gray-100 flex items-center justify-center w-10/12 rounded-lg">
      Loading comments...
    </div>;
  }

  return (
    <div className="min-h-screen md:w-10/12  text-gray-100  bg-gray-900 rounded-md py-4">
